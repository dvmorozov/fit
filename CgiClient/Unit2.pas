...
begin
    ...
    //  sozdanie zadachi
    ProblemID := Proxy.FitStub.CreateProblem;
    WriteProblemFile(ProjectName, FileName, ProblemID);
...
begin
    ...
    try
        //  global'naya peremennaya - ispol'zuetsya dlya vypolneniya zaprosa
        ProblemID := StrToInt(Application.RequestVariables['problem_id']);
    except
    ...
    GetDataNames(ProblemID, UserName, ProjectName, FileName);
...
begin
    ...
    begin
        ...
        Pair[1][1] := 'ProblemID'; Pair[1][2] := IntToStr(ProblemID);
