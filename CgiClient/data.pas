...
type
    TStringPair = array[1..2] of string;
...
const
    ...
    PairArray: array[1..PairCount] of TStringPair = (
        ...
        *)
        ...
        +
        'To change the point type its argument and new value. ' + 'Finally press the button.'
...
begin
    ...
    for Index := 0 to PairCount - 1 do
        Result := StringReplace(Result, Pairs[Index][1],
            Pairs[Index][2], [rfReplaceAll]);
end;
