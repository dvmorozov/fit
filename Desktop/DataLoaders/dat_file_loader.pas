...
var
    ...
    BegFound: boolean;
    BegIndex: longint;
    Value1Found, Value2Found, FirstDelimiter, ValueEnded: boolean;
begin
    ...
    begin
        ...
        begin
            ...
            try
                ...
                begin
                    //  Either a separator arrives, or a second point/comma ends
                    //  the number being read - both mean the same thing, so the
                    //  extraction below is written once and both paths set the
                    //  flag that reaches it. It was a goto into the else branch,
                    //  and a user-declared label is the one thing the assembler
                    //  on x86_64-darwin will not take.
                    ValueEnded := False;
