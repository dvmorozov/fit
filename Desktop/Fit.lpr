...
{$ENDIF}{$ENDIF}
    ...
    Forms, Variants, app, form_main, about_box_dialog, input_wavelength_dialog,
    ...
    configurable_user_points_set, int_fit_service,
    fit_server, fit_task, int_fit_server,
