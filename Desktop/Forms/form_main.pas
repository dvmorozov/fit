...
uses
    ...
    , fit_progress, fit_progress_explanations
...
begin
    ...
    //  Registered unconditionally: every build can fit, so every build shows the
    //  progress view and has to be able to say what it is.
