...
{ A strip of zoom buttons down the left of a pane, built to match the toolbars
  the other bottom tabs carry in the designed form: 27 px wide at the design
  density, icons only, no captions, the same image list.
...
begin
    ...
    //  The same 25 px pitch the designed toolbars are laid out on, scaled with
    //  everything else.
