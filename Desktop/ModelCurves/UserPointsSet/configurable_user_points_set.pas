...
{$IF NOT DEFINED(FIT_NO_UI) AND NOT DEFINED(CLIENT_PROXY)}
...
{$IF NOT DEFINED(FIT_NO_UI) AND NOT DEFINED(CLIENT_PROXY)}
//  NOTHING OF THE WIDGET SET HERE, and nothing of the application: the dialogs
//  are behind the adapters below. This unit is compiled into the server and the
//  plain test suite too, and the Controls, Dialogs and app it used to name -
//  none of them used - stopped both from building without the LCL.
uses
