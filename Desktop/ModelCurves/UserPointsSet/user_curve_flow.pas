    ...
    begin
        ...
        begin
            ...
            case ARoles.Ask(ct) of
                ...
                begin
                    //  CANCELLED TAKES THE DRAFT AWAY TOO. It used to stay, while
                    //  the window said the curve had not been created - the
                    //  message and the User menu contradicting each other, and
                    //  a type with no roles left in the list.
                    AStorage.DeleteCurveType(ct);
