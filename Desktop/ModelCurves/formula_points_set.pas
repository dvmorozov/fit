...
uses
    ...
    coordinate_axis, curve_points_set, named_points_set, points_set,
...
type
    ...
    public
        ...
        { Every lineshape built on this base is a diffraction peak, so its
          argument is the scattering angle and its value the intensity. A future
          non-diffraction formula curve overrides this back to the inherited
          preference for none. }
...
class function TFormulaPointsSet.PreferredAxisMode(
