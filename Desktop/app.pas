...
uses
    //  NOT Forms. Nothing here touches the widget set - this unit holds two
    //  objects and the wiring between them - and naming it put the whole LCL
    //  on the dependency path of everything that reaches these two globals,
    //  including, through a module's front door, the COMPUTE SERVER.
    SysUtils,
    fit_client_app,
    http_fit_service,
    server_connection
...
initialization
    ...
    FitService_ := THttpFitService.Create(DefaultServerUrl);
