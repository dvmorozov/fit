...
type
    ...
    private
        ...
        FLossKind:   longint;
        FPriceValueColumn: longint;
        FPriceArgument: longint;
    ...
    published
        ...
        { How a price-data (.csv) file is read: which column is the value
          (ohlc_csv_loader.TOhlcValueColumn, 0 = Close) and what the argument
          is (TOhlcXMode, 0 = the bar number). 0 is what a file written before
          these existed says, and is the loader's own default. }
        property PriceValueColumn: longint
            read FPriceValueColumn write FPriceValueColumn;
        property PriceArgument: longint read FPriceArgument write FPriceArgument;
