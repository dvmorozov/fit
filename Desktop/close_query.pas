...
WHAT THE RULES ARE, in one place now:
  ...
  * Each modified document is asked about SEPARATELY, and saying no to one says
    nothing about another. The window has one today - the project, which holds
    both tables - so it asks one question, "Project has been modified. Save?".
