...
begin
    ...
    AddParagraph(Result, 'A type can be chosen before any data is loaded. While ' +
        'the axis rule is From Curve Type, choosing a type also sets the ' +
        'argument axis.');
...
begin
    ...
    AddParagraph(Result, 'Each row names a curve and its position. For a curve ' +
        'type placed from its own markup the tab shows that structure instead, ' +
        'as the curve pack describes it.');
...
begin
    ...
    AddParagraph(Result, 'A user-defined curve is fitted like any other: place ' +
        ...
        'project. Under the From Curve Type axis rule it is shown against a plain ' +
        'Position.');
