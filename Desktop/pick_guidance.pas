...
const
    ...
    { A menu item a prompt names is named by its full path, as the menu shows
      it: "Select Area" named an entry that does not exist. }
    HintSelectProfileInterval =
        'Now you can pick the menu item "Data > Range > Select Data Interval"';
    HintNextPoint =
        'Now you can pick a next point or the menu item "Fit > Minimize Difference"';
    HintNextBackPoint = 'Now you can pick a next point or the menu item ' +
