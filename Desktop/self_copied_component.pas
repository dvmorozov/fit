...
var
    i:   longint;
begin
    CheckThat(Dest.ClassType = Self.ClassType, 'a component list may only copy itself into a list of its own class');
...
begin
    CheckIndex(Index, Count, 'the component list being deleted from');
...
begin
    CheckThat(Dest.ClassType = Self.ClassType, 'a component may only copy itself into a component of its own class');
end;
