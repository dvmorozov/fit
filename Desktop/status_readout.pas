...
begin
    if not AStats.Valid then
        Exit('');
    //  The two figures worth a glance; the full set - AIC and BIC among them -
    //  is saved with the project. %.4g for the chi-squared because its magnitude varies by orders
