...
uses
    ...
    linear_points_set,
    //  What the module explains, and the menu it declares.
    example_explanations, example_ui;

procedure RegisterExampleModule;
begin
    //  EVERYTHING A MODULE ADDS EXPLAINS ITSELF: its curve type through its own
    //  class, anything else through a provider registered here.
    RegisterExampleExplanations;
    RegisterExampleUi;
