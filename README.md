...
that accuracy allows. See [the fitting workflow](docs/user-guide/fitting-workflow.md#letting-the-program-decompose-the-profile)
and [how it decides](https://dvmorozov.github.io/fit/how-many-curves.html).
