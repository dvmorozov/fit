...
type
    ...
    protected
        ...
        procedure TakeProgressSnapshot(ANow: TDateTime);
...
begin
    ...
    FProgressLog.Start(Now, ProgressLossName, ProgressEngineName);
...
procedure TFitService.TakeProgressSnapshot(ANow: TDateTime);
var
