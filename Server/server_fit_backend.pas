...
uses
    ...
    //  What the remote server reaches while it fits, relayed into the task.
    remote_fit_progress;
...
begin
    ...
    //  The same contract the Python sidecar keeps, so a fit on a remote server
    //  shows its progress as a local one does. See remote_fit_progress.
