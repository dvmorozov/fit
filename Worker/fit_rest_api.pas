...
begin
    ...
    //  GET /problems/{id}/progress?since=<seq>&snapshot=0|1 - how a running fit
        ...
        begin
            ...
            begin
                ...
                AResponse := ErrorResponse(
                    ...
                    'be started. Set it up as the user guide describes, in ' +
                    'docs/user-guide/compute-backends.md');
                Exit;
            end;
        end;
        ...
        begin
            ...
            begin
                ...
                AResponse := ErrorResponse('The Python backend is not available. ' +
                    'Set it up as the user guide describes, in ' +
                    'docs/user-guide/compute-backends.md');
                Exit;
            end;
        end;
