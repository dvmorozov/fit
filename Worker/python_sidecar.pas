...
var
    ...
    { The script in a repository checked out beside the one this binary was built
      in, or ''. Which paths those are is a decision and lives in sidecar_launch;
      listing a directory to learn the names is not, so it is done here. }
    function SiblingScript: string;
    var
    ...
    begin
        ...
        try
            SidecarUmbrellaCandidates(Umbrellas, BinDir);
