...
fpc -MDelphi -SIcorba -dFIT -dFITCLIENT -dFITSERVER \
  -Futests/no-modules -Futests/fitminimizers -FuDesktop -FuDesktop/DataLoaders -FuDesktop/DataSources -FuDesktop/ModelCurves -FuDesktop/ModelCurves/CurveParameters -FuDesktop/ModelCurves/UserPointsSet -FuServer -FuServer/interfaces -FuCommon -FuWorker -Futests/mocks \
  -Fu"$FITMINIMIZERS" \
