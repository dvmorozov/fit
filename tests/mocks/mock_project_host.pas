...
type
    ...
    public
        ...
        { The data file the window was last told to load, or ''. }
        property Loaded: string read FLoaded;
...
procedure TMockProjectHost.LoadProfile(const APath: string);
begin
    FLog.Note('LoadProfile', APath);
    FLoaded := APath;
end;
