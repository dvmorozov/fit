...
const
    ...
    CodeBuiltMenuPaths: array[0..12] of string = (
        'Help > Explain Everything',
        'Fit > Loss Function',
        'Model > Clear Model',
        'Model > Curve Type > User > New User Curve',
        'Data > Argument Transformation > Use Rule > From Curve Type',
        'Data > Argument Transformation > Use Rule > General Position',
        'Data > Argument Transformation > Use Rule > Custom Position',
        'Data > Price Data > Value > Close',
        'Data > Price Data > Value > Open',
        'Data > Price Data > Value > High',
        'Data > Price Data > Value > Low',
        'Data > Price Data > Argument > Bar Number',
        'Data > Price Data > Argument > Date');
